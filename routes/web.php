...
use App\Http\Controllers\Faculty\FacultyFacultiesController;
...
Route::group(['middleware'=>['auth','faculty']], function () {
    ...
    Route::get('/faculties', [FacultyFacultiesController::class, 'index'])->name('faculty.faculties');
    Route::get('/create-faculty', [FacultyFacultiesController::class, 'createFaculty'])->name('faculty.create-faculty');
});
