...
Vue.component('resultcard', require('./components/ResultCard.vue').default);
...
Vue.component('adminnavbar', require('./components/Faculty/AdminNavbar.vue').default);
...
Vue.component('faculties', require('./components/Faculty/FacultiesNew.vue').default);
Vue.component('create-faculty', require('./components/Faculty/CreateFaculty.vue').default);
