@extends('layouts.app')
@section('content')
<title>PLE-REAP | TRIAL EXAM RESULT</title>
...
<body>
    <div class="card px-5 pb-5 shadow" style="background-color: rgba(0, 0, 0, 0); font-family: Verdana, Geneva, Tahoma, sans-serif;">
        ...
        <div class="card-header p-4" style="background-color: rgba(0, 0, 0, 0.5); border-top-left-radius: 20px; border-top-right-radius: 20px;">
            <div class="d-flex justify-content-between pt-0 mt-0">
                <div>
                    <p class="h1 p-0 m-0 text-white" style="font-style: italic;">Trial Exam Results</p>
                    <p class="display-4 p-0 m-0 text-white font-weight-bold">{{ $maintopc }}</p>     
                </div>
          ...
          <div class="card-body" style="background-color: #f5f5f5; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">
            ...
            <div class="px-5 py-3 justify-content-center">
              ...
              @foreach($ques as $q)
                ...
                <hr class="bg-light border mt-0 pt-0" />
              @endforeach
              <h3 class="text-center" style="font-weight: bold;">Summary of Score</h3>
              <hr class="bg-light border mt-0 pt-0" />
